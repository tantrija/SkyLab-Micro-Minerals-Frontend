        ...
        onSubmit: {
            "ContactPage.useFormik[formik]": async (values, param)=>{
                ...
                try {
                    ...
                    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$Services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/royal/contact", values);
                    console.log(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$Services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], "=========================");
                    ...
                    if (response.status === 200 || response.status === 201) {
                        ...
                        setSubmitStatus({
                            type: 'success',
                            message: ((_response_data = response.data) === null || _response_data === void 0 ? void 0 : _response_data.message) || 'Form submitted successfully! Our team will contact you soon.'
                        });
                        resetForm();
                    } else {
                        throw new Error("Unexpected response status: ".concat(response.status));
                    }
                } catch (error) {
                    var _error_response;
                    ...
                    if (error.response) {
                        ...
                        if (typeof errorData === 'string') {
                        ...
                        } else if (errorData === null || errorData === void 0 ? void 0 : errorData.msg) {
                            ...
                            errorMessage += "Server error: ".concat(error.response.status);
                        }
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                        ...
                                                        className: "inline-flex items-center justify-center gap-3 h-14 px-8 rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold hover:from-blue-700 hover:to-blue-800 active:scale-[0.98] transition-all duration-200 shadow-lg hover:shadow-xl ".concat(isSubmitting ? 'opacity-70 cursor-not-allowed' : ''),
                                                    ...
                                                    submitStatus && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "p-3 rounded-lg mt-2 ".concat(submitStatus.type === 'success' ? 'bg-green-50 text-green-700 border border-green-200' : 'bg-red-50 text-red-700 border border-red-200'),
...
_s(ContactPage, "6ydRjPZbG7HYuZHnEW1ZwjSc7As=", false, function() {
    return [
...
//# sourceMappingURL=_9cfbc25d._.js.map
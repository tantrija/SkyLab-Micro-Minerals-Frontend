      ...
      <div className="grid items-stretch md:gap-8 gap-3 md:grid-cols-[1.05fr_1.2fr] ">
        ...
        <div
          className={cn(
            ...
            "bg-[#0146a3] text-white ring-1 ring-[#0146a3]/5"
          )}
        >
          {/* Eyebrow and Title */}
          ...
          <button
            ...
            className="absolute right-6 top-6 grid size-10 place-items-center rounded-lg bg-[#0146a3]/10 text-[#0146a3] ring-1 ring-white/25 transition-colors hover:bg-[#0146a3]/15"
          >
